        ...
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="custom-li-back"><a href="login.php"><span class="fa  fa-sign-in"></span> Login</a></li>
                </ul>
...
<div class="jumbotron">
 	...
 	<form action="log.php" class="form-horizontal" method="post">	
 	...
 	<div class="col-lg-4">
 	<input type="password" class="form-control" name="pass" id="user-name" placeholder="Enter your password" required="">
 	</div>
 	</div>
 	<div class="form-group">
 	<p class="col-lg-4"></p>
...
if(isset($_POST['btn']))
{
	$usern = mysql_real_escape_string($_POST['user']);
